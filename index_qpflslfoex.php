...
<head>
    ...
    <link rel="stylesheet" href="finexo.css">
...
<body>
    <div class="container" id="header">
        <div class="row">
            <div class="col-sm-6" style="vertical-align: left ">
                <a href="https://www.finexo.com/ru/"> <img src="images/finexo-logo.png" alt="FINEXO" id="logo_3" style="margin-left: 3%;"> </a>
            </div>
            <div class="container" id="logos">
                <div class="col-sm-6" style="vertical-align: right;">
                    <a href="https://vk.com/finexo_forex"><img src="images/vk.png" id="vk" alt="vk" id="logo" class="ex1" align="right"> </a>
                    <a href="https://twitter.com/FINEXO_forex"><img src="images/twitter.png" id="twitter" alt="twitter" id="logo" class="ex1" align="right"> </a>
                    <a href="https://www.facebook.com/finexoforex/"><img src="images/facebook.png" id="facebook" alt="facebook" id="logo" class="ex1" align="right"> </a>
                </div>
            </div>
        </div>
    </div>
	<iframe width="100%" noresize="noresize" scrolling="no" height="30" frameborder="0" src="https://widgets.tc2000.com/WidgetServer.ashx?id=37406"></iframe>
    <div class="container" id="content">
        <div class="row">
            <div class="col-12" align="center" style="margin-top: 2%;">
                <h1 style="color:#ffffff" class="shadowtext" id="slogan1" align="center">
                    </br>
                    </br>
                    <strong>Торгуйте профессионально</strong>
                    </h1>
                <h2 style="color:#ffffff" class="shadowtext" id="slogan1" align="center">
Развивайте свои навыки в Центре обучения: все инструменты и материалы доступны бесплатно.</h2>
                <br>
                <br>
                <form class="form-horizontal" action="thankyou.php" method="post"> >
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="u_name" id="firstName" placeholder="Введите имя"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="u_email" id="lastName" placeholder="email"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="phone_number" name="subj" placeholder="Номер телефона"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="hidden" class="form-control" name="message" value="Empty_hidden_menu" placeholder="Доп информация (Не обязательно)"> </div>
                    </div>
                    <br>
                    <a href="https://www.finexo.com/ru/live-registration">
                        <button type="submit" type="button" class="btn btn-success btn-lg" id="button" class="shadow">НАЧАТЬ ОБУЧЕНИЕ</button>
                    </a>
                </form>
            </div>
        </div>
        <div class="footer col-12">
            <!-- Widget Area -->
            <div class="b-widgets col-12 col-lg-9">
                <div class="layout">
                    <div class="row">
                                    ...
                                    <div class="content col-lg-12">
                                        <div class="ssl_icons">
                                            <ul style="display:initial;">
                                                ...
                                                <li><img src="images/verisign.png" style="margin-right: 24px;margin-left: 9px;"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row-item col-2_3">
                            <div class="region region-footer-icons">
                                <div id="block-block-46" class="block block-block">
                                    <div class="content">
                                        <div class="bank_icons" style="margin-top:-10px;"> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12" >
                        <div class="region region-footer-copy">
                            <div id="block-block-50" class="block block-block">
                                <div class="content">
                                    <p class="col-lg-10">FINEXO.com - это торговое название ООО<a target="_blank" href="http://www.leadcapitalmarkets.com/regulation.php"> Leadcapital Markets Ltd</a>, которая авторизована и регулируется <a target="_blank" href="http://www.cysec.gov.cy/en-GB/home/"> Комиссией по ценным бумагам и биржам Республики Кипр</a>, и имеет лицензионный номер <a target="_blank" href="http://www.cysec.gov.cy/en-GB/entities/investment-firms/cypriot/37648/">227/14</a>. Адрес фирмы: Treppides Tower, 5th Floor, 9 Kafkasou Street, 2112 Никосия, Кипр.</p>
                                    <p class="col-lg-10">Ограничительные юрисдикции: Мы не открываем счета для резидентов определенных юрисдикций, включая Японию, Канаду и США. Для получения более подробной информации, пожалуйста читайте <a href="en/terms-conditions" target="_blank">Правила &amp; Условия.</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="b-copyright col-12 col-lg-11">
                <div class="layout">
                    <div class="f-a">
